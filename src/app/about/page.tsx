...
export default function AboutPage() {
    return (
        <main
            className="min-h-screen flex flex-col items-center justify-start px-4 sm:px-6 pt-20 sm:pt-28 md:pt-36 pb-12 sm:pb-20"
            style={{
        ...
        >
            <section 
                className="flex flex-col items-center gap-3 sm:gap-4 px-3 sm:px-4 py-5 sm:py-6 mt-2 sm:mt-4 rounded-xl sm:rounded-2xl border-2"
                style={{
                    borderColor: '#e6d4a3',
            ...
            >
                <img 
                    className='w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 object-contain rounded-full border-2 border-[#e6d4a3] mb-2 sm:mb-4 p-1'
                    src='/background/lady.jpeg'
                    alt='Lady of the Shrooms portrait'
                />
                
                <div className="text-center mb-3 sm:mb-4 px-2">
                    <h1 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 text-[#8b6b40]">Lady of the Shrooms</h1>
